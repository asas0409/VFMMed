...
class UNETR_FREEZE(nn.Module):
    ...
    def __init__(
        ...
        self.seg_head3 = nn.Conv3d(768, out_channels, kernel_size=1)
        self.seg_head2 = nn.Conv3d(128, out_channels, kernel_size=1)
        self.seg_head1 = nn.Conv3d(64, out_channels, kernel_size=1)
        self.seg_head0 = nn.Conv3d(32, out_channels, kernel_size=1)
    ...
    def forward(self, x_in):
        ...
        seg3 = self.seg_head3(dec4)
        seg2 = self.seg_head2(dec3)
        seg1 = self.seg_head1(dec2)
        seg0 = self.seg_head0(dec1)
...
class UNETR(nn.Module):
    ...
    def __init__(
        ...
        num_heads: int = 12,
        proj_type: str = "conv",
        norm_name: tuple | str = ("group", {"num_groups": 16}),
        conv_block: bool = True,
        res_block: bool = True,
        dropout_rate: float = 0.0,
        spatial_dims: int = 3,
